...
# VERSİYON
# =========================================================
VERSION_NAME = "Balina Avcısı V6.1 MEXC ANA VERİ + MEXC OI/FUNDING + WS STR DATA FIX V5.2 - GİRİŞ YERİ FIX"
...
MEXC_REST_RATE_LIMIT_COOLDOWN_SEC = float(os.getenv("MEXC_REST_RATE_LIMIT_COOLDOWN_SEC", "45"))
...
HOT_SCAN_INTERVAL_SEC = float(os.getenv("HOT_SCAN_INTERVAL_SEC", "5"))
DEEP_SCAN_INTERVAL_SEC = float(os.getenv("DEEP_SCAN_INTERVAL_SEC", "12"))
...
MAX_DEEP_ANALYSIS_PER_CYCLE = int(float(os.getenv("MAX_DEEP_ANALYSIS_PER_CYCLE", "6")))
...
PRO_WS_SYMBOL_LIMIT = int(float(os.getenv("PRO_WS_SYMBOL_LIMIT", "50")))
